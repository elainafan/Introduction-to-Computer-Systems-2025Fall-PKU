...
0000000000401ef9 <getbuf_withcanary>:
  ...
  401efd:	48 81 ec 20 01 00 00 	sub    $0x120,%rsp
  401f04:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401f0b:	00 00 
  401f0d:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
  401f11:	31 c0                	xor    %eax,%eax
  401f13:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%rbp)
  401f1a:	48 8d 85 60 ff ff ff 	lea    -0xa0(%rbp),%rax
  401f21:	48 89 c7             	mov    %rax,%rdi
  401f24:	e8 bd 02 00 00       	call   4021e6 <Gets>
  401f29:	8b 45 e4             	mov    -0x1c(%rbp),%eax
  401f2c:	48 98                	cltq
  401f2e:	48 8d 95 e0 fe ff ff 	lea    -0x120(%rbp),%rdx
  401f35:	48 8d 0c 02          	lea    (%rdx,%rax,1),%rcx
  401f39:	48 8d 85 60 ff ff ff 	lea    -0xa0(%rbp),%rax
  401f40:	ba 80 00 00 00       	mov    $0x80,%edx
  401f45:	48 89 c6             	mov    %rax,%rsi
  401f48:	48 89 cf             	mov    %rcx,%rdi
  401f4b:	e8 f0 f1 ff ff       	call   401140 <memcpy@plt>
